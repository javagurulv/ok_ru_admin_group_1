package student_sergey_egorichev.lesson_10.level_3.task_17;
...
public class AuthorSearchCriteriaTest {
    ...
    public void mathTest1 () {
        ...
        SearchCriteria asc = new AuthorSearchCriteria("author2");
    ...
    public void mathTest2 () {
        ...
        SearchCriteria asc = new AuthorSearchCriteria("author3");
    ...
    public void mathTest3 () {
        ...
        SearchCriteria asc = new AuthorSearchCriteria("author1");
